% Problem 4
% Phasor mag on a lossy line with OC load
...
figure
hold on
plot(z,Vsa,'color',[0.9    0.7    0.1], 'linewidth', 2) 
plot(z,Isa, 'k-')
yyaxis left
xlabel('z (m)')
ylabel('Voltage (V)')
...
text(-1.5,0.2, 'Reflection coefficient = 1')

figure
hold on
plot(z,Vsb, 'color',[0.9    0.7    0.1], 'linewidth', 2) 
plot(z,Isb, 'k-')
yyaxis left
xlabel('z (m)')
ylabel('Voltage (V)')
...
figure
hold on
plot(z,Vsc, 'color',[0.9    0.7    0.1], 'linewidth', 2) 
plot(z,Isc, 'k-')
yyaxis left
xlabel('z (m)')
ylabel('Voltage (V)')
...
figure
hold on
plot(z,Vsd, 'color',[0.9    0.7    0.1], 'linewidth', 2) 
plot(z,Isd, 'k.')
yyaxis left
xlabel('z (m)')
ylabel('Voltage (V)')
